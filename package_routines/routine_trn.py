...
def routine_trn(
  ...
  for id_batch, (batch_names, batch_images) in enumerate(loader):
    ...
    showcase_image(batch_images, batch_images_noisy, batch_target_noise, batch_predicted_noise, id_epoch, id_batch, batch_names, 'trn', p.RESULTS_IMAGES_EPOCHS, p.RGB_OR_GRAYSCALE)
